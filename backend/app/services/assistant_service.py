...
LEARNING_SUMMARY_ENGLISH_PHRASES = (
    "analyse learning history",
    "analyse my learning history",
    "analyse my progress",
    "analyse my study history",
    "analyze learning history",
    "analyze my learning history",
    "analyze my progress",
    "analyze my study history",
    "how am i doing",
    "learning history",
    "learning summary",
    "my learning summary",
