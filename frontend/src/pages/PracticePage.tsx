      ...
      <div className="mx-auto flex max-w-[1680px] flex-col gap-4">
        ...
        >
          ...
          <aside className="grid min-w-0 content-start gap-4">
            ...
            />
            <HintPanel messages={session.hintMessages} isHinting={isHinting} onRequestHint={handleHint} />
            <MasteryWidget masteryProfile={session.masteryProfile} weakKcs={weakKcs} />
